...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
			{ "U_B_PilotCoveralls", "Military Police", 25, { "", "", -1 } },
        ...
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
			{ "H_CrewHelmetHeli_B", "Military Police", 75, { "", "", -1 } },
    ...
    class med_clothing {
        ...
        uniforms[] = {
			...
			{ "U_Marshal", "UN Medic", 50, { "", "", -1 } },
			{ "U_B_CTRG_3", "UN Soldier", 50, { "", "", -1 } },
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_blu", "", 10, { "", "", -1 } },
        ...
        vests[] = {
            { "NONE", "Remove Vest", 0, { "", "", -1 } },
			{ "V_PlateCarrier2_rgr", "", 1500, { "life_mediclevel", "SCALAR", 2 } },
