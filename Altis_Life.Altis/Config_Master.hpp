...
class Life_Settings {
    ...
    /* Initial Bank Amount */
    bank_cop = 700000; //Amount of cash on bank for new cops
    bank_civ = 700000; //Amount of cash on bank for new civillians
    bank_med = 700000; //Amount of cash on bank for new medics
